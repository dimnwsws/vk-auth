<template>
  <div class="min-h-screen w-full flex items-center justify-center bg-gray-900 text-gray-200 px-4">
    <div class="w-full max-w-xl bg-gray-800 rounded-xl shadow-2xl p-8 text-center">
      ...
      <h1 class="text-2xl sm:text-3xl font-bold mb-4">Ожидание подтверждения</h1>
